...
namespace PallasDotnetN2n
{    
    public static class PallasDotnetN2n
    {
        ...
        public static NodeToNodeWrapper Connect(
            string server,
            ulong networkMagic
        ) {
        ...
        [StructLayout(LayoutKind.Sequential)]
        private struct _StructNodeToNodeWrapper {
            public UIntPtr clientPtr;
            public static _StructNodeToNodeWrapper Encode(NodeToNodeWrapper structArg) {
                return new _StructNodeToNodeWrapper {
                    clientPtr = structArg.clientPtr
                };
            }
            public NodeToNodeWrapper Decode() {
                return new NodeToNodeWrapper {
                    clientPtr = this.clientPtr
                };
            }
        }
        [DllImport("pallas_dotnet_n2n", EntryPoint = "rnet_export_connect", CallingConvention = CallingConvention.Cdecl)]
        private static extern _StructNodeToNodeWrapper _FnConnect(
            _RawSlice server,
            ulong networkMagic
        );
        ...
        [DllImport("pallas_dotnet_n2n", EntryPoint = "rnet_export_submit_tx", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("pallas_dotnet_n2n", EntryPoint = "rnet_alloc", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr _Alloc( UIntPtr size, UIntPtr align);

        [DllImport("pallas_dotnet_n2n", EntryPoint = "rnet_free", CallingConvention = CallingConvention.Cdecl)]
